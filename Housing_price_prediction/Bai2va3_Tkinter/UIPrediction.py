...
class UIPrediction:
    ...
    def create_ui(self):
        self.root = Tk()
        self.root.title("Dataset Viewer - House Pricing Prediction tool")
        self.root.geometry("1200x600")
        #  Bọc toàn bộ layout trong canvas có thanh cuộn
        ...
        #  Thay vì self.root làm cha của main_panel, ta nhét nó vào canvas
        frame_container = Frame(canvas)
        canvas.create_window((0, 0), window=frame_container, anchor="nw")
        main_panel = PanedWindow(frame_container)
